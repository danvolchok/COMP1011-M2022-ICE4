...
public final class Utility
{
    ...
    // Step 3. - Create a public static access method that returns an instance to the class
    public static Utility Instance()
    {
        // Step 4. - Ensure that your instance member variable has not been instantiated aka is null
        if(m_instance == null)
        {
            // Step 5. - create an instance of the class and save a reference in the private variable
    ...
    /**
     * This is a helper method that configures a spinner of type Double for a Vector2D component (x or y)
     * @param spinner
     * @param min
     * @param max
     * @param default_value
